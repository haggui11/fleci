...
<section class="category-products clearfix mt-3">
  <h2 class="tt-title">
	...
	<div class="customNavigation">
		<div class="btn-prev">
		<a class="btn prev Categoryproducts_prev">{l s='Prev' d='Modules.Categoryproducts.Shop'}</a>
		</div>
		<div class="btn-next">
		<a class="btn next Categoryproducts_next">{l s='Next' d='Modules.Categoryproducts.Shop'}</a>
		</div>
	</div>
    {/if}
