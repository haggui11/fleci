              ...
              {if isset($product) && $product}
                ...
                {block name='product_cover'}
                  <div class="product-cover">
                    {if $product.cover}
                      <img class="js-qv-product-cover" src="{$product.cover.bySize.medium_default.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}" style="width:100%;" loading="lazy">
                    {else}
                      <img src="{$urls.no_picture_image.bySize.large_default.url nofilter}" style="width:100%;" loading="lazy">
                    {/if}
                  </div>
                {/block}
              {/if}
		...
		<div class="reviewcomment-modal">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 post-comment-buttons">
              <button type="button" class="btn btn-secondary" data-dismiss="modal" aria-label="{l s='Cancel' d='Modules.Productcomments.Shop'}">
