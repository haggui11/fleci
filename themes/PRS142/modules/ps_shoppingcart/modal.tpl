      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-6 divide-right">
            <div class="row">
              <div class="col-xs-4 col-md-5 product-img">
              ...
              <div class="col-xs-8 col-md-7 product-desc">
          ...
          <div class="col-md-6 divide-left">
			...
			{hook h='displayCartModalContent' product=$product}
              <div class="cart-content-btn">
                ...
                <a href="{$cart_url}" class="btn btn-secondary"><i class="material-icons rtl-no-flip">&#xE876;</i>{l s='Proceed to checkout' d='Shop.Theme.Actions'}</a>
              </div>
            </div>
          </div>
        </div>
