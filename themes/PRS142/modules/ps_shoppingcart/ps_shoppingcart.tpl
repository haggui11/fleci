...
<div id="_desktop_cart">
  <div class="blockcart cart-preview {if $cart.products_count > 0}active{else}inactive{/if}" data-refresh-url="{$refresh_url}">
    <div class="header">
        ...
        <span class="cart-products-count"> <span class="cart-count">{l s='items' d='Shop.Theme.Checkout'}</span> {$cart.products_count}</span>
        </a>
    </div>
	...
	data-full-size-image-url = "{$products.cover.large.url}" loading="lazy"/>
			</a>
		{/block}
		</div>
		<div class="cart-info">
