...
<article class="product-miniature js-product-miniature col-sm-4" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" >
	   ...
	   <!-- @todo: use include file='catalog/_partials/product-flags.tpl'} -->
		...
		<div class="ttproduct-desc">
          ...
          {if $page.page_name == 'index'}
            <span class="h3 product-title"><a href="{$product.canonical_url}">{$product.name|truncate:18:'...'}</a></span>
          {else}
            <span class="h3 product-title"><a href="{$product.canonical_url}">{$product.name|truncate:18:'...'}</a></span>
          {/if}
        {/block}
				...
				{block name='product_description_short'}
					<div class="product-desc-short">{$product.description_short|strip_tags:'UTF-8'|truncate:80:'...' nofilter}</div>
				{/block}
