...
class TtMegamenuRowClass extends ObjectModel
{
    public $id_ttmegamenu;
    public $class;
    public $active;
    public static $definition = array(
        'table' => 'ttmegamenu_row',
        'primary' => 'id_row',
        'multilang_shop' => true,
        'fields' => array(
            'id_ttmegamenu' => array(
    ...
    {
        parent::__construct($id_row, $id_lang, $id_shop, $context);
        Shop::addTableAssociation('ttmegamenu_row', array(
            'type' => 'shop'
        ));
    }
