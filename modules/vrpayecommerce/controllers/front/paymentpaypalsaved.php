...
class VrpayecommercePaymentPaypalSavedModuleFrontController extends VrpayecommercePaymentAbstractModuleFrontController
{
    protected $payment_method = 'PAYPALSAVED';
    protected $template_name = 'payment_form_paypalsaved.tpl';
    protected $payment_type = 'DB';
    protected $payment_brand = 'PAYPAL';
    protected $recurring = true;
    protected $recurring_group = 'PAYPAL';
