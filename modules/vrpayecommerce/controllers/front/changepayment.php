...
class VrpayecommerceChangePaymentModuleFrontController extends VrpayecommercePaymentAbstractModuleFrontController
{
    public $auth = true;
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        $recurringTranscationParameters = $this->getRecurringPaymentParameters($id);
        ...
        $this->context->smarty->assign(array(
            ...
            'paymentResponseUrl' =>
                $this->context->link->getModuleLink(
                    'vrpayecommerce',
                    'paymentresponse',
                    array('payment_method' => $selectedPayment, 'recurring_id' => $id),
                    true
                )
        ));
        $this->setTemplate('module:vrpayecommerce/views/templates/front/change_payment.tpl');
    }
