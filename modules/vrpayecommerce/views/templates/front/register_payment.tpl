...
{else}
    ...
    <section id="main">  
        <header class="page-header">
            <h1>
                {if {l s='FRONTEND_MC_ADD' mod='vrpayecommerce'} == "FRONTEND_MC_ADD"}Save Payment Information{else}{l s='FRONTEND_MC_ADD' mod='vrpayecommerce'}{/if}
            </h1>
        </header>
            ...
            <script type="text/javascript"> 
                var wpwlOptions = {
                    ...
                    onReady: function(){
                        ...
                        var buttonConfirm = "{if {l s='FRONTEND_MC_BT_REGISTER' mod='vrpayecommerce'} == 'FRONTEND_MC_BT_REGISTER'}Register{else}{l s='FRONTEND_MC_BT_REGISTER' mod='vrpayecommerce'}{/if}";
