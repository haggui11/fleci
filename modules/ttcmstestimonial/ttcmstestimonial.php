...
class TtCmstestimonial extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('TT - CMS Testimonial block', [], 'Modules.Customtext.Admin');
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<div class="tttestimonial-content container"><div class="tttestimonial-inner"><ul id="tttestimonial-carousel" class="tt-carousel"><li><div class="testimonial-content col-sm-12"><div class="testimonial-image col-sm-3"><img alt="" src="../img/cms/user1.jpg" /></div><div class="testimonial-content-desc col-sm-9"><h4>John Doe</h4><span class="user-designation">co-founder</span><p>Duis faucibus enim vitae nunc molestie, nec facilisis arcu pulvinar. Nullam mattisarcu pulvinar. Eullam mattis arcu convallis, bibendum.</p></div></div></li><li><div class="testimonial-content col-sm-12"><div class="testimonial-image col-sm-3"><img alt="" src="../img/cms/user2.jpg" /></div><div class="testimonial-content-desc col-sm-9"><h4>John Doe</h4><span class="user-designation">co-founder</span><p>Duis faucibus enim vitae nunc molestie, nec facilisis arcu pulvinar. Nullam mattisarcu pulvinar. Eullam mattis arcu convallis, bibendum.</p></div></div></li><li><div class="testimonial-content col-sm-12"><div class="testimonial-image col-sm-3"><img alt="" src="../img/cms/user3.jpg" /></div><div class="testimonial-content-desc col-sm-9"><h4>John Doe</h4><span class="user-designation">co-founder</span><p>Duis faucibus enim vitae nunc molestie, nec facilisis arcu pulvinar. Nullam mattisarcu pulvinar. Eullam mattis arcu convallis, bibendum.</p></div></div></li></ul></div></div>'
            ),
        );
