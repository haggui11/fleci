...
class TtCmspaymentlogo extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('TT - CMS Paymentlogo block', [], 'Modules.Customtext.Admin');
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<div class="payment_logo_block"><ul class="payment-list"><li class="visa"><a href="#"> <img src="../img/cms/payment-visa.png" alt="visa" /></a></li><li class="mastercard"><a href="#"> <img src="../img/cms/payment-mastercard.png" alt="mastercard" /></a></li><li class="paypal"><a href="#"> <img src="../img/cms/payment-paypal.png" alt="paypal" /></a></li></ul></div>'
            ),
        );
